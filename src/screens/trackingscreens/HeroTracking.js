...
useEffect(()=>{
  ...
  console.log("dateChanged",typeof state.date)
},[state.date])
        ...
        <SafeAreaView style={{flex: 1}}>
          ...
          <TouchableOpacity
            ...
            <Text style={{color: '#fff'}}>
              {compareAsc(format(new Date(), 'MM-DD'), format(new Date(state.date), 'MM-DD')) === 0 ? "Today" : format(new Date(state.date).toString(), 'MMM DD YYYY')}
            </Text>
          </TouchableOpacity>
          <View
            style={{
